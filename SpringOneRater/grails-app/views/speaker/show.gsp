	...
	<body>
		...
		<div id="show-speaker" class="content scaffold-show" role="main">
			...
			<ol class="property-list speaker">
				...
				<g:if test="${speakerInstance?.sessionName}">
				<li class="fieldcontain">
					<span id="sessionName-label" class="property-label"><g:message code="speaker.sessionName.label" default="Session Name" /></span>
					
						<span class="property-value" aria-labelledby="sessionName-label"><g:fieldValue bean="${speakerInstance}" field="sessionName"/></span>
